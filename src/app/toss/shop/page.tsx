...
export default function TossShopPage() {
  return (
    <div className="flex flex-1 flex-col px-5 py-6">
      <h2 className="mb-1 text-[20px] font-bold text-gray-900">굿즈 쇼핑</h2>
      ...
      <div className="flex flex-1 flex-col items-center justify-center py-16">
        ...
        <Link
          href="/toss"
          className="rounded-xl bg-purple-500 px-6 py-3 text-[14px] font-semibold text-white transition-colors active:bg-purple-600"
        >
          홈으로 돌아가기
        </Link>
      </div>
